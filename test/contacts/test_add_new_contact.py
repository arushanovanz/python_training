...
def test_add_new_contact(app):
    ...
    contact = ContactProperties (firstname="Andrew", middlename="Ivanovich", lastname="Lobachev", nickname="green",
                                                      photo= "",title="Title1",
                                                      company="Company1",address= "Adress1 Company1",homephone="89779087650",mobilephone="89779087651",
                                                      workphone="89779087652",fax="89779087653",email="andrew1@tt.ru",email2="andrew2@tt.ru",
                                                      email3="andrew3@tt.ru",homepage="andrew.tt.ru",address2="Secondary Adress",
                                                      secondaryphone="Secondary Home",notes="some new notes",ayear="1994",amonth="January",aday ="1",
